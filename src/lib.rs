...
impl Script {
    ...
    pub fn to_hb_script(self) -> harfbuzz_sys::hb_script_t {
        ...
        match self {
            ...
            Gunjala_Gondi => HB_SCRIPT_UNKNOWN,
            Gurmukhi => HB_SCRIPT_GURMUKHI,
            Han => HB_SCRIPT_HAN,
            Hangul => HB_SCRIPT_HANGUL,
            Hanifi_Rohingya => HB_SCRIPT_UNKNOWN,
